...
class DashboardTablet extends StatelessWidget {
  DashboardTablet({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    var providerMenuTablet = Provider.of<ProviderNavBarTablet>(context);
      ...
      return WillPopScope(
        ...
        child: Scaffold(
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            currentIndex: providerMenuTablet.menu,
            selectedItemColor: Colors.purple.shade300,
            unselectedItemColor: Colors.grey.shade300,
            onTap: (index) => providerMenuTablet.menu = index,
          ),
        ),
      );
    });
