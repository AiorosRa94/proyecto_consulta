...
class IngresarTablet extends StatelessWidget {
  const IngresarTablet({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        ImagenContainer(imagen: "assets/ingresar.png",altoContainer: 3),
        Padding(
        ...
        Padding(
          padding: EdgeInsets.only(top: Pantalla(context).altoDisp(0.4)),
          child: Container (
              color: Colors.white,
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Row(
                      ...
                      children: [
                        TextoContainer(texto: "${providerIngresar.historicoIngresar[index].producto}", colorTexto: Colors.grey.shade500, alineacionTexto: TextAlign.start, tamanoTexto: 0.4, altoContainer: 0.5,anchoContainer: 3, paddingTexto: 0),
                        TextoContainer(texto: "${providerIngresar.historicoIngresar[index].cantidad}", colorTexto: Colors.green, alineacionTexto: TextAlign.center, tamanoTexto: 0.4, altoContainer: 0.5,anchoContainer: 2, paddingTexto: 0)
                      ],
                    );
                  }
              )
