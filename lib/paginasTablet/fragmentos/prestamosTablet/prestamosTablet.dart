...
class PrestamosTablet extends StatelessWidget {
  const PrestamosTablet({Key? key}) : super(key: key);
        ...
        Padding(
          ...
          child: SizedBox (
            ...
            child: Row(
              ...
              children: [
                InputSugerenciasProducto(listaSug: providerSqliteProducto.listaSugerencias, controlador: controladorProducto,controladorStock: controladorEnStock,etiqueta: "Articulo o REF",anchoDisp: 3,altoDisp: 0.5,padding: 0, tamanoTexto: 0.2,),
                InputContainer(controlador: controladorEnStock,etiqueta: "En Stock",anchoDisp: 2.3,altoDisp: 0.5,padding: 0, tamanoTexto: 0.2,),
                InputContainer(controlador: controladorCuantos,etiqueta: "¿Cuantos?",anchoDisp: 2.3,altoDisp: 0.5,padding: 0, tamanoTexto: 0.2,),
        ...
        Padding(
          ...
          child: SizedBox (
            ...
            child: Row(
              ...
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                InputSugerenciasCliente(listaSug: providerSqliteCliente.listaSugerencias, controlador: controladorQuien,etiqueta: "¿Quien?",anchoDisp: 3,altoDisp: 0.5,padding: 0, tamanoTexto: 0.2,),
                Padding(
        ...
        Padding(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                providerMenuDashboardTablet.menu = 5;
              },
