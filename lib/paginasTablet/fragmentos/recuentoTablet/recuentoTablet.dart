...
class RecuentoTablet extends StatelessWidget {
  const RecuentoTablet({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        ImagenContainer(imagen: "assets/recuento.png",altoContainer: 3),
        Padding(
          ...
          child: SizedBox (
            ...
            child: Row(
              ...
              children: [
                ...
                InputContainer(controlador: controladorAjustar,etiqueta: "Ajustar",anchoDisp: 2.3,altoDisp: 0.5,padding: 0, tamanoTexto: 0.2,),
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Row(
                      ...
                      children: [
                        TextoContainer(texto: "${providerRecuento.historicoRecuento[index].producto}", colorTexto: Colors.grey.shade500, alineacionTexto: TextAlign.start, tamanoTexto: 0.4, altoContainer: 0.5,anchoContainer: 3, paddingTexto: 0),
                        TextoContainer(texto: "${providerRecuento.historicoRecuento[index].cantidad}", colorTexto: Colors.blue, alineacionTexto: TextAlign.center, tamanoTexto: 0.4, altoContainer: 0.5,anchoContainer: 2, paddingTexto: 0)
                      ],
                    );
                  }
              )
