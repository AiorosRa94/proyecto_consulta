...
import 'package:proyecto_consulta/APIs/sacar/apiSacar.dart';
...
class SacarTablet extends StatelessWidget {
  const SacarTablet({Key? key}) : super(key: key);


  @override
  Widget build(BuildContext context) {

    var providerSacar = Provider.of<ProviderSacar>(context);
    var providerSqlite = Provider.of<ProviderCRUDProducto>(context);
    var providerUsuario = Provider.of<ProviderUsuario>(context);


    ApiSacar apiSacar = ApiSacar();
    ...
    return Column(
      children: [
        ...
        ImagenContainer(imagen: "assets/sacar.png",altoContainer: 2,),
        Padding(
          ...
          child: SizedBox (
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
              ...
              children: [
                InputSugerenciasProducto(listaSug: providerSqlite.listaSugerencias, controlador: controladorProducto,controladorStock: controladorEnStock,etiqueta: "Articulo o REF",anchoDisp: 3,altoDisp: 0.5,padding: 0, tamanoTexto: 0.2,),
                InputContainer(controlador: controladorEnStock,etiqueta: "En Stock",anchoDisp: 2.3,altoDisp: 0.5,padding: 0, tamanoTexto: 0.2,),
                InputContainer(controlador: controladorCantidad,etiqueta: "¿Cuantos?",anchoDisp: 2.3,altoDisp: 0.5,padding: 0, tamanoTexto: 0.2,),
              ],
            ),
        ...
        SizedBox(
          height: Pantalla(context).altoDisp(0.8) ,
          width: Pantalla(context).anchoDisp(8),
          child: Row(
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      EasyLoading.show(status: 'Sacando...');

                      Producto prd = await  providerSqlite.selectProducto(controladorProducto.text);
                      final respuesta = await apiSacar.sacarDeStock(double.parse(controladorCantidad.text), prd.varianteId,prd.nombre,providerUsuario.token);
                      if(respuesta.statusCode == 200){
                        EasyLoading.dismiss();
                        providerSacar.nuevoProducto = EstructuraHistorico(producto: controladorProducto.text, cantidad: double.parse(controladorCantidad.text));
                        ...
                        await FlutterPlatformAlert.showAlert(
                          windowTitle: '¡Oh no!',
                          text: 'Ocurrio un error al intentar sacar el producto',
                          alertStyle: AlertButtonStyle.ok,
                          iconStyle: IconStyle.information,
                        );
                      }
                    },
                    child:  TextoAutoajustable(texto: "Sacar",colorTexto: Colors.white,),
        ...
        Padding(
          ...
          child: Container (
            ...
            child: ListView.builder(
                itemCount: providerSacar.historicoSacar.length,
                itemBuilder: (BuildContext context, int index) {
                  return Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      TextoContainer(texto: "${providerSacar.historicoSacar[index].producto}", colorTexto: Colors.grey.shade500, alineacionTexto: TextAlign.start, tamanoTexto: 0.4, altoContainer: 0.5,anchoContainer: 3, paddingTexto: 0),
                      TextoContainer(texto: "${providerSacar.historicoSacar[index].cantidad}", colorTexto: Colors.redAccent, alineacionTexto: TextAlign.center, tamanoTexto: 0.4, altoContainer: 0.5,anchoContainer: 2, paddingTexto: 0),
