...
class InputSugerenciasProducto extends StatelessWidget {
  final List<String> listaSug;
  final double? anchoDisp, altoDisp, padding, tamanoTexto;
  final TextEditingController controlador,controladorStock;
  final Color? colorInput;
  final String? etiqueta;
  const InputSugerenciasProducto({required this.listaSug, this.anchoDisp, this.altoDisp, this.padding, this.colorInput, this.etiqueta,required this.controlador, this.tamanoTexto, required this.controladorStock});
          ...
          child: TextFieldAutoComplete(
              ...
              itemSubmitted: (String item)  async {
                ...
                controlador.text = item;
                 final Producto prd = await providerSqlite.selectProducto(controlador.text);
                 controladorStock.text =  prd.enStock;
              },
