...
class Sacar extends StatelessWidget {
  const Sacar({Key? key}) : super(key: key);
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Row(
                    ...
                    children: [
                      TextoContainer(texto: "${providerSacar.historicoSacar[index].producto}", colorTexto: Colors.grey.shade500, alineacionTexto: TextAlign.start, tamanoTexto: 0.25, altoContainer: 0.5,anchoContainer: 3, paddingTexto: 0),
                      TextoContainer(texto: "${providerSacar.historicoSacar[index].cantidad}", colorTexto: Colors.redAccent, alineacionTexto: TextAlign.center, tamanoTexto: 0.25, altoContainer: 0.5,anchoContainer: 2, paddingTexto: 0),
