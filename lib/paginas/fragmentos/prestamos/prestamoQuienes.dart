...
import 'package:proyecto_consulta/paginas/fragmentos/prestamos/prestamoHistorico.dart';
...
class PrestamosQuienes extends StatelessWidget {
  const PrestamosQuienes({Key? key}) : super(key: key);
                    ...
                    if (snapshot.hasData) {
                      children = <Widget>[
                        Padding(
                          ...
                          child: TextoContainer(texto: "Clientes recientes", anchoContainer: 8, altoContainer: 0.3, tamanoTexto: 0.2,colorTexto: Colors.grey,),
                        ),
                        ListView.separated(
                          ...
                          shrinkWrap: true,
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return ListTile(
                                ...
                                title: TextoContainer(texto: snapshot.data!.data[index].cliente, pesoTexto: FontWeight.bold,tamanoTexto: 0.2, alineacionTexto: TextAlign.start,altoContainer: 0.3,paddingTexto: 0,),
                                subtitle: TextoContainer(texto: snapshot.data!.data[index].contactoCliente,tamanoTexto: 0.15,colorTexto: Colors.grey, alineacionTexto: TextAlign.start,altoContainer: 0.2,paddingTexto: 0,),
                              onTap: (){
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) =>  PrestamoHistorico(datos: snapshot.data!, indexCliente: index)),
                                );                              },
                              );
                            },
